...
- A provider outage (Resend or SES down, erroring, or rate-limiting) no longer uses up recipients' retries: the send stays open and retries every tick until the provider is back, and mails everyone exactly once, instead of recording the whole audience unsent after about five minutes and closing as sent (SPEC §12).
