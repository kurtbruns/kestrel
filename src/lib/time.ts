/**
 * Timing constants for the send loop, the sweep, and subscribing. The minimum lead is not
 * one of them: it is deploy config (`Config.minLeadMs`, SPEC §6), with its default and floor
 * in `shared/sends.ts`.
 */
