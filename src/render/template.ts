...
<style>
  ...
  @media (prefers-color-scheme: dark) {
    ...
    .k-card { background:#232327 !important; }
...
<body class="k-bg" style="margin:0;padding:0;background:#f4f4f5;">
${preheader}
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" class="k-bg" style="background:#f4f4f5;"><tr><td align="center" style="padding:24px 12px;">
<table role="presentation" width="600" cellpadding="0" cellspacing="0" class="k-card" style="max-width:600px;width:100%;background:#ffffff;border-radius:8px;overflow:hidden;">
<tr><td class="k-body" style="padding:32px;font-family:${FONT};font-size:16px;line-height:1.6;color:#18181b;word-break:break-word;">
${i.contentHtml}
</td></tr>
