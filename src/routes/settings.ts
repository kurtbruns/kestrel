...
const ADDRESS_NOT_PRINTED =
  "You've added a mailing address in Settings, but this template doesn't print it, so your emails go out without it. If you send promotional email, US law requires a postal address in each one: add {{ publication.address }} back to the footer. If you don't need to provide one, remove the address in Settings.";
